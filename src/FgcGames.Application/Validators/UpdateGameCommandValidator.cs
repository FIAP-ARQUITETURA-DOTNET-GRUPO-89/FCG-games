...
public class UpdateGameCommandValidator : AbstractValidator<UpdateGameCommand>
{
    ...
    public UpdateGameCommandValidator(IGameRepository repository)
    {
        RuleFor(x => x.Nome)
            .NotEmpty()
            ...
            .MustAsync(async (command, nome, ct) =>
                !await repository.ExisteComNomeAsync(nome, command.Id))
        ...
        RuleFor(x => x.DataLancamento)
            .NotEmpty()
                .WithMessage("A data de lançamento é obrigatória.");
