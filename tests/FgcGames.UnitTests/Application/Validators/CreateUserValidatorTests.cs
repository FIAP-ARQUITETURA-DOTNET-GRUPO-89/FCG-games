...
public class CreateUserValidatorTests
{
    ...
    {
        var command = new CreateUserCommand("", "jonatas@email.com", new DateOnly(1990, 1, 1), "Senha@123");
    ...
    {
        var command = new CreateUserCommand("Jonatas", "email-invalido", new DateOnly(1990, 1, 1), "Senha@123");
    ...
    {
        var command = new CreateUserCommand("Jonatas", "jonatas@email.com", new DateOnly(1990, 1, 1), "12345678");
